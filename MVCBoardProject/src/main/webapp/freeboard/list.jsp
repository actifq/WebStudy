		...
		<table id="table_content">
			<tr>
				<td align=right>
					...
					<a href="list.do?page=${curpage>1?curpage-1:curpage }"><img src="freeboard/image/prev.gif" border=0></a>&nbsp;
					
					<a href="list.do?page=${curpage<totalpage?curpage+1:curpage }"><img src="freeboard/image/next.gif" border=0></a>&nbsp;&nbsp;
