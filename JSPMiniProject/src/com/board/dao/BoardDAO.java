...
public class BoardDAO {
	...
	public List<BoardDTO> boardAllData(int page)
	{
		...
		try
		{
			...
			// 오라클 안에서 페이지 자르기 (최신순이 맨 위)
			// inline-view (Select 안에 select... 가상테이블 (메모리에 저장하지 않은 채 가져온다)
		...
		return list;
		/*
		 * INSERT INTO databoard VALUES(db_no_seq.nextval,'홍길동','파일 없음','파일무','1234',
SYSDATE,0,'',0);
		 */
	...
	public void boardInsert(BoardDTO d)
	{
		try
		{
			...
			ps.setString(5, d.getFilename());ps.setInt(6, d.getFilesize());
			ps.executeUpdate();
