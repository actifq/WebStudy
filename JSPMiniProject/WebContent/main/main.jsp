...
<body>
  <center>
    <table border=1 bordercolor="black" width=900 height=700 cellpadding=0 cellspacing=0>
      <tr>
        <td colspan="2" height=100 background="../image/back2.jpg" align=center>
          <font size=3 color="white"><b>JSP Include & DBCP & Session</b></font>
          </td>
      </tr>
      <tr>
        ...
        <td width=500 height=500 style="margin-top: 50px">
