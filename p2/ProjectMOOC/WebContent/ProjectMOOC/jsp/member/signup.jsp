...
<body>
	...
	<center>
	<legend class="sumain">Sign up with E-Mail</legend>
...
<form class="form-horizontal ng-pristine ng-valid ng-valid-email" role="form">
	...
	<div class="row">
		<div class="col-sm-6 col-xs-12"  style="margin-bottom:10px;">
			...
			<input type="text"  class="form-control ng-pristine ng-untouched ng-valid" id="firstName" placeholder="First Name">
		</div>
		<div class="col-sm-6 col-xs-12" style="margin-bottom:10px;">
			<label for="lastName">Last Name</label>
			<input type="text"  class="form-control ng-pristine ng-untouched ng-valid" id="lastName" placeholder="Last Name">
		</div>
	</div>
	...
	<div class="row onboarding-form-group">
		<div class="col-sm-12 col-xs-12">
			<div>
				...
				<input type="text"  class="form-control ng-pristine ng-untouched ng-valid ng-valid-email" id="email" placeholder="email">
			</div>
		</div>
	</div>
	...
	<div class="row onboarding-form-group">
		<div class="col-md-12 col-xs-12">
			<div>
				...
				<input type="password" class="form-control ng-pristine ng-untouched ng-valid" id="password" placeholder="password">
			</div>
		</div>
	</div>
	<p></p>
...
<div class="row row-gap-medium ng-scope">
	<p class="col-xs-6 col-xs-offset-3 bold text-center">Already Sign Up? 
