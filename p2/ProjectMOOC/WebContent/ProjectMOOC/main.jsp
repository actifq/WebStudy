	...
	<div id="page-wrapper">
		...
		<section id="banner">
			<div class="content">
				...
				<span class="image"><img src="image/pic02.jpg" alt=""/></span>
			</div>
					...
					<div class="row">
						...
						<div class="4u 12u$(medium)">
							<p>Feugiat accumsan lorem eu ac lorem amet sed accumsan
								...
								consequat adipiscing lorem dolor.</p>
						</div>
						<div class="4u$ 12u$(medium)">
		...
		<section id="two" class="spotlight style2 right">
			...
			<div class="content">
				...
				<p>Feugiat accumsan lorem eu ac lorem amet ac arcu phasellus
					...
					cep aliquet augue varius tempus lobortis porttitor lorem et
		...
		<section id="three" class="spotlight style3 left">
			...
			<div class="content">
				<header>
					...
					<p>Accumsan integer ultricies aliquam vel massa sapien
						phasellus</p>
				</header>
				<p>Feugiat accumsan lorem eu ac lorem amet ac arcu phasellus
					tortor enim mi mi nisi praesent adipiscing. Integer mi sed nascetur
